...
export const s = {
  ...
  devBar:   { display: 'flex', alignItems: 'center', gap: '0.4rem', paddingLeft: '0.5rem', borderLeft: '1px solid #1a1a20' },
  devLabel: { fontSize: '0.62rem', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase' as const, color: '#3f3f46' },
  devBtn:   { fontSize: '0.72rem', padding: '0.25rem 0.6rem', background: 'transparent', border: '1px solid #2a2a30', borderRadius: '4px', color: '#555', cursor: 'pointer' },
